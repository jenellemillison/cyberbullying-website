...
<section id="analytics" class="services-mf pt-5 route">
  ...
  ';
  if($topic == '')
	  $numGenderBullyQuery = "SELECT count, TRUNCATE(cyberbullying_category_pct, 2) from SummaryStats WHERE topic LIKE \"%All%\" AND cyberbullying_category LIKE \"gender\";";
  else
	  $numGenderBullyQuery = "SELECT count, TRUNCATE(cyberbullying_category_pct, 2) from SummaryStats WHERE topic LIKE \"%". $topic ."%\" AND cyberbullying_category LIKE \"gender\";";
